...
class automod(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if message.channel.permissions_for(message.guild.default_role).send_messages:
...
If you don't already have a `Steeler` or higher subscription, you can get one at [patreon.com/stylized](https://www.patreon.com/Stylized).""", color=message.guild.me.color)
